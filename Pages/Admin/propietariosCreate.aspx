<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="propietariosCreate.aspx.cs" Inherits="Muni.Pages.propietariosCreate" %>
...
<body style="background-color:#2c3d63">
    <form id="form1" runat="server">
        ...
        <div style="text-align:center">
            <asp:Label ID="catergoryLbl" runat="server" Font-Names="Bahnschrift" Font-Size="75px" ForeColor="White" Text="Crear propietarios"></asp:Label>       
        </div>
        <div style="text-align:center;margin-top:50px">
            <asp:Label ID="labelNombrePropietario" runat="server" Text="Nombre del propietario" Font-Names="Bahnschrift" ForeColor="White"  Font-Size="30px"></asp:Label>
            <br/>
            ...
            <br/>
            <asp:Label ID="labelDocID" runat="server" Text="Documento legal" Font-Names="Bahnschrift" ForeColor="White"  Font-Size="30px"></asp:Label>
            <br/>
            ...
            <br/>
            <asp:Label ID="labelIDType" runat="server" Text="Tipo de Documento Legal" Font-Names="Bahnschrift" ForeColor="White"  Font-Size="30px"></asp:Label>
            <br/>
            ...
            <br/>
            <br/>
            <asp:Button ID="addPropietarioBtn" runat="server" Text="Agregar propietario" Width="500px" BorderWidth="0px" Font-Bold="True" Font-Names="Bahnschrift" Font-Size="40px" ForeColor="White" style="margin-top:10px ;background-color:#addcca" OnClick="addPropietarioBtn_Click"/>
            <br/>
            <br/>
            <br/>
